 ...
 * .main classes
 */
function froots_main_class() {
  if (froots_display_sidebar()) {
 ...
 */
function froots_display_sidebar() {
  ...
  return apply_filters('froots_display_sidebar', $sidebar_config->display);
}
