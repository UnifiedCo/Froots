 ...
 */
function froots_root_relative_url($input) {
...
if (froots_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'froots_root_relative_url');
}
